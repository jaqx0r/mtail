...
func TestProcessLogLineDoesNotPinLargeCaptureGroup(t *testing.T) {
	...
	prog := []code.Instr{
		...
		{Opcode: code.Push, Operand: 0, SourceLine: 0},    // Index of capture group
		{Opcode: code.Capref, Operand: 1, SourceLine: 0},  // Capture group 1
		{Opcode: code.Push, Operand: m[0], SourceLine: 0}, // Metric object
		{Opcode: code.Dload, Operand: 1, SourceLine: 0},   // 1 label
	}
